...
class NurseryRhymeTest < MiniTest::Unit::TestCase
 ...
 def test_line_2
  ...
  def test_line_4
    ...
    assert_equal expected, rhyme.line(4)
  end
  ...
  def test_line_5
    ...
    assert_equal expected, rhyme.line(5)
  end
  ...
  def test_line_6
    ...
    assert_equal expected, rhyme.line(6)
  end
  ...
  def test_line_7
    ...
    assert_equal expected, rhyme.line(7)
  end
  ...
  def test_line_11
    ...
    assert_equal expected, rhyme.line(11)
  end
...
TEXT
    assert_equal expected, rhyme.recite_everything
  end
